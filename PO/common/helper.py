...
class Helper(object):
    def readExceles(self, rows):
        book = xlrd.open_workbook("D:\\PyCharm 2019.1.1\\workspace\\python自动化测试学习\\PO\\data\\info.xlsx", "r")
    ...
    def dirname(self, filename, filepath='D:\\PyCharm 2019.1.1\\workspace\\python自动化测试学习\\PO\\data'):
